...
import practica3.Funcionbatman;
import practica3.BatmanPolimorfo;
/**
 *
 * @author jhona
 */
public class Batman {
    ...
    public static List<Integer> numeroscompuestosbatman(){
        ...
        for(int numero: lista) {
            ...
            public static Funcionbatman componer(Funcionbatman funcionUno, Funcionbatman funcionDos, Funcionbatman funcionTres) {
        return new Funcionbatman() {
            public int opera(int x) {
                return funcionUno.opera(funcionDos.opera(funcionTres.opera(x)));
                //return funcionUno.opera(x) && funcionDos.opera(x) && funcionTres.opera(x);
            }
        };
    }
     ...
     */
     public static void main(String[] args) {
        ...
        listacompuesta=numeroscompuestosbatman();
            System.out.println("imprimirendo lista genereada con funciones compuestas : \n");
        imprimirLista(listacompuesta);
        List<Integer> listapolimorfa = new LinkedList<>();
        
        listapolimorfa=numerospolimorfosbatman();
            System.out.println("imprimirendo lista genereada con funciones polimorfas : \n");
